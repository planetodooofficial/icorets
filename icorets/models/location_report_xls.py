...
class LocationReport(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet.write(0, 18, 'Colour', bold)
        sheet.write(0, 19, 'Size', bold)
        sheet.write(0, 20, 'MRP', bold)
        sheet.write(0, 21, 'GST', bold)
        sheet.write(0, 22, 'IHO Stock', bold)
        sheet.write(0, 23, 'Bhiwandi Stock', bold)
        sheet.write(0, 24, 'Delhi Stock', bold)
        sheet.write(0, 25, 'Total Qty', bold)
        sheet.write(0, 26, 'Quotation Qty', bold)
        sheet.write(0, 27, 'Confirmed SO qty', bold)
        sheet.write(0, 28, 'FREE TO USE', bold)
        sheet.write(0, 29, 'PO Receipt Pending', bold)
        sheet.write(0, 30, 'To Replenish', bold)
        sheet.write(0, 31, 'Product Net Weight (gms)', bold)
        sheet.write(0, 32, 'Product Dimension (cm)', bold)
        sheet.write(0, 33, 'Product Dimension (cm)', bold)
        sheet.write(0, 34, 'Product Dimension (cm)', bold)
        sheet.write(0, 35, 'Package Weight (gms)', bold)
        sheet.write(0, 36, 'Package Dimension (cm)', bold)
        sheet.write(0, 37, 'Package Dimension (cm)', bold)
        sheet.write(0, 38, 'Package Dimension (cm)', bold)
        ...
        for product_id, data in sorted(product_data.items(), key=lambda x: (x[1]['Brand'].lower(), x[1]['Category 1'].lower(), x[1]['Category 2'].lower(), x[1]['Category 3'].lower())):
            ...
            sheet.write(row, col + 18, data['Colour'])
            sheet.write(row, col + 19, data['Size'])
            sheet.write(row, col + 20, data['MRP'])
            sheet.write(row, col + 21, data['GST'])
            sheet.write(row, col + 22, data['IHO Stock'])
            sheet.write(row, col + 23, data['Bhiwandi Stock'])
            sheet.write(row, col + 24, data['Delhi Stock'])
            sheet.write(row, col + 25, data['Total'])
            sheet.write(row, col + 26, data['Quotation Qty'])
            sheet.write(row, col + 27, data['Confirmed SO qty'])
            sheet.write(row, col + 28, data['FREE TO USE'])
            sheet.write(row, col + 29, data['PO Receipt Pending'])
            sheet.write(row, col + 30, data['To Replenish'])
