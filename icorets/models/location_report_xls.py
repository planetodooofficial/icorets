...
class LocationReportWizard(models.TransientModel):
    ...
    def location_report_xlsx(self):
        ...
        sheet.write(0, 49, 'Confirmed SO qty', bold)
        sheet.write(0, 50, 'FREE TO USE', bold)
        sheet.write(0, 51, 'PO Receipt Pending', bold)
        sheet.write(0, 52, 'To Replenish', bold)
        sheet.write(0, 53, 'Bullet Point 1', bold)
        sheet.write(0, 54, 'Bullet Point 2', bold)
        sheet.write(0, 55, 'Bullet Point 3', bold)
        sheet.write(0, 56, 'Bullet Point 4', bold)
        sheet.write(0, 57, 'Bullet Point 5', bold)
        sheet.write(0, 58, 'Description', bold)
        sheet.write(0, 59, 'Google Drive Link', bold)
        sheet.write(0, 60, 'Drop Box Link', bold)
        sheet.write(0, 61, 'Country of Origin', bold)
        sheet.write(0, 62, 'Product Net Weight (gms)', bold)
        sheet.write(0, 63, 'Product Length (cm)', bold)
        sheet.write(0, 64, 'Product Breadth (cm)', bold)
        sheet.write(0, 65, 'Product Height (cm)', bold)
        sheet.write(0, 66, 'Package Gross Weight (gms)', bold)
        sheet.write(0, 67, 'Package Length (cm)', bold)
        sheet.write(0, 68, 'Package Breadth (cm)', bold)
        sheet.write(0, 69, 'Package Height (cm)', bold)
        # sheet.write(0, 30, '(Onhand + incoming) - outgoing', bold)
        # sheet.write(0, 31, '(Onhand + incoming) - outgoing(With_Qtn)', bold)

        sheet.write(0, 70, 'Opening Stock', bold_yellow)
        sheet.write(0, 71, 'Purchase', bold_yellow)
        sheet.write(0, 72, 'Purchase Return', bold_yellow)
        sheet.write(0, 73, 'Net Purchase', bold_yellow)
        sheet.write(0, 74, 'Sales', bold_yellow)
        sheet.write(0, 75, 'Sales Return', bold_yellow)
        sheet.write(0, 76, 'Net Sales', bold_yellow)
        sheet.write(0, 77, 'Closing Stock', bold_yellow)
        sheet.write(0, 78, 'Pending SOs customers', bold_yellow)
        sheet.write(0, 79, 'Pending POs vendors', bold_yellow)
        ...
        for product_id, data in sorted(product_data.items(), key=lambda x: (
            ...
            sheet.write(row, col + 49, data['Confirmed SO qty'])
            sheet.write(row, col + 50, data['FREE TO USE'])
            sheet.write(row, col + 51, data['PO Receipt Pending'])
            sheet.write(row, col + 52, data['To Replenish'])

            sheet.write(row, col + 53, data['Bullet Point 1'])
            sheet.write(row, col + 54, data['Bullet Point 2'])
            sheet.write(row, col + 55, data['Bullet Point 3'])
            sheet.write(row, col + 56, data['Bullet Point 4'])
            sheet.write(row, col + 57, data['Bullet Point 5'])
            sheet.write(row, col + 58, data['Description'])
            sheet.write(row, col + 59, data['Google Drive Link'])
            sheet.write(row, col + 60, data['Drop Box Link'])
            sheet.write(row, col + 61, data['Country of Origin'])

            sheet.write(row, col + 62, data['Product Net Weight (gms)'])
            sheet.write(row, col + 63, data['Product Length (cm)'])
            sheet.write(row, col + 64, data['Product Breadth (cm)'])
            sheet.write(row, col + 65, data['Product Height (cm)'])
            sheet.write(row, col + 66, data['Package Gross Weight (gms)'])
            sheet.write(row, col + 67, data['Package Length (cm)'])
            sheet.write(row, col + 68, data['Package Breadth (cm)'])
            sheet.write(row, col + 69, data['Package Height (cm)'])
            # sheet.write(row, col +30, data['(Onhand + incoming) - outgoing'])
            # sheet.write(row, col + 31, data['(Onhand + incoming) - outgoing(With_Qtn)'])

            sheet.write(row, col + 70, data['Opening Stock'])
            sheet.write(row, col + 71, data['Purchase'])
            sheet.write(row, col + 72, data['Purchase Return'])
            sheet.write(row, col + 73, data['Net Purchase'])
            sheet.write(row, col + 74, data['Sales'])
            sheet.write(row, col + 75, data['Sales Return'])
            sheet.write(row, col + 76, data['Net Sales'])
            sheet.write(row, col + 77, data['Closing Stock'])
            sheet.write(row, col + 78, data['Pending SOs customers'])
            sheet.write(row, col + 79, data['Pending POs vendors'])
