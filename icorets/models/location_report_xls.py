...
class LocationReportWizard(models.TransientModel):
    ...
    def location_report_xlsx(self):
        ...
        bold_yellow = workbook.add_format(
            {'font_size': 11, 'align': 'vcenter', 'bold': True, 'bg_color': '#ffff1a', 'font': 'Calibri Light',
             'text_wrap': True, 'border': 1})
        ...
        sheet.set_column(0, 57, 25)
        sheet.set_column(0, 58, 25)
        sheet.set_column(0, 59, 25)
        sheet.set_column(0, 60, 25)
        sheet.set_column(0, 61, 25)
        ...
        sheet.write(0, 29, 'COST Price', bold)
        sheet.write(0, 30, 'GST', bold)
        sheet.write(0, 31, 'IHO Stock', bold)
        sheet.write(0, 32, 'Bhiwandi Stock', bold)
        sheet.write(0, 33, 'Delhi Stock', bold)
        sheet.write(0, 34, 'BHU Stock', bold)
        sheet.write(0, 35, 'DHASA Stock', bold)
        sheet.write(0, 36, 'ELM Stock', bold)
        sheet.write(0, 37, 'JSP Stock', bold)
        sheet.write(0, 38, 'JWD Stock', bold)
        sheet.write(0, 39, 'RCP Stock', bold)
        sheet.write(0, 40, 'UPW Stock', bold)
        sheet.write(0, 41, 'BWMIS Stock', bold)
        sheet.write(0, 42, 'CH Stock', bold)
        sheet.write(0, 43, 'Customer Location', bold)
        sheet.write(0, 44, 'Vendor Location', bold)
        sheet.write(0, 45, 'Virtual Locations/Inventory adjustment', bold)
        sheet.write(0, 46, 'Damage/Stock', bold)
        sheet.write(0, 47, 'Virtual Locations/Production', bold)
        sheet.write(0, 48, 'Total Qty', bold)
        sheet.write(0, 49, 'Quotation Qty', bold)
        sheet.write(0, 50, 'Confirmed SO qty', bold)
        sheet.write(0, 51, 'FREE TO USE', bold)
        sheet.write(0, 52, 'PO Receipt Pending', bold)
        sheet.write(0, 53, 'To Replenish', bold)
        sheet.write(0, 54, 'Bullet Point 1', bold)
        sheet.write(0, 55, 'Bullet Point 2', bold)
        sheet.write(0, 56, 'Bullet Point 3', bold)
        sheet.write(0, 57, 'Bullet Point 4', bold)
        sheet.write(0, 58, 'Bullet Point 5', bold)
        sheet.write(0, 59, 'Description', bold)
        sheet.write(0, 60, 'Google Drive Link', bold)
        sheet.write(0, 61, 'Drop Box Link', bold)
        sheet.write(0, 62, 'Country of Origin', bold)
        sheet.write(0, 63, 'Product Net Weight (gms)', bold)
        sheet.write(0, 64, 'Product Length (cm)', bold)
        sheet.write(0, 65, 'Product Breadth (cm)', bold)
        sheet.write(0, 66, 'Product Height (cm)', bold)
        sheet.write(0, 67, 'Package Gross Weight (gms)', bold)
        ...
        sheet.write(0, 71, 'Opening Stock', bold_yellow)
        sheet.write(0, 72, 'Purchase', bold_yellow)
        sheet.write(0, 73, 'Purchase Return', bold_yellow)
        sheet.write(0, 74, 'Net Purchase', bold_yellow)
        sheet.write(0, 75, 'Sales', bold_yellow)
        sheet.write(0, 76, 'Sales Return', bold_yellow)
        sheet.write(0, 77, 'Net Sales', bold_yellow)
        ...
        for product in products:
            ...
            # ===========================================================
            # domain = [('product_id', '=', product.id), ('inventory_date', '<', self.from_date)]
            # history = self.env['stock.quant'].search(domain)
            # opening_stock = sum(history.mapped('quantity'))
            # print('podct++++++++++++++++++', product, product.name)
            ...
            # domain = [('product_id', '=', product.id), ('inventory_date', '>', self.to_date)]
            # history = self.env['stock.quant'].search(domain)
            # closing_stock = sum(history.mapped('quantity'))
        ...
        for product_id, data in sorted(product_data.items(), key=lambda x: (
            ...
            sheet.write(row, col + 29, data['COST Price'])
            sheet.write(row, col + 30, data['GST'])
            sheet.write(row, col + 31, data['IHO Stock'])
            sheet.write(row, col + 32, data['Bhiwandi Stock'])
            sheet.write(row, col + 33, data['Delhi Stock'])
            sheet.write(row, col + 34, data['BHU Stock'])
            sheet.write(row, col + 35, data['DHASA Stock'])
            sheet.write(row, col + 36, data['ELM Stock'])
            sheet.write(row, col + 37, data['JSP Stock'])
            sheet.write(row, col + 38, data['JWD Stock'])
            sheet.write(row, col + 39, data['RCP Stock'])
            sheet.write(row, col + 40, data['UPW Stock'])
            sheet.write(row, col + 41, data['BWMIS Stock'])
            sheet.write(row, col + 42, data['CH Stock'])
            sheet.write(row, col + 43, data['Customer Location'])
            sheet.write(row, col + 44, data['Vendor Location'])
            sheet.write(row, col + 45, data['Virtual Locations/Inventory adjustment'])
            sheet.write(row, col + 46, data['Damage/Stock'])
            sheet.write(row, col + 47, data['Virtual Locations/Production'])
            sheet.write(row, col + 48, data['Total'])
            sheet.write(row, col + 49, data['Quotation Qty'])
            sheet.write(row, col + 50, data['Confirmed SO qty'])
            sheet.write(row, col + 51, data['FREE TO USE'])
            sheet.write(row, col + 52, data['PO Receipt Pending'])
            sheet.write(row, col + 53, data['To Replenish'])

            sheet.write(row, col + 54, data['Bullet Point 1'])
            sheet.write(row, col + 55, data['Bullet Point 2'])
            sheet.write(row, col + 56, data['Bullet Point 3'])
            sheet.write(row, col + 57, data['Bullet Point 4'])
            sheet.write(row, col + 58, data['Bullet Point 5'])
            sheet.write(row, col + 59, data['Description'])
            sheet.write(row, col + 60, data['Google Drive Link'])
            sheet.write(row, col + 61, data['Drop Box Link'])
            sheet.write(row, col + 62, data['Country of Origin'])

            sheet.write(row, col + 63, data['Product Net Weight (gms)'])
            sheet.write(row, col + 64, data['Product Length (cm)'])
            sheet.write(row, col + 65, data['Product Breadth (cm)'])
            sheet.write(row, col + 66, data['Product Height (cm)'])
            sheet.write(row, col + 67, data['Package Gross Weight (gms)'])
            ...
            sheet.write(row, col + 71, data['Opening Stock'])
            sheet.write(row, col + 72, data['Purchase'])
            sheet.write(row, col + 73, data['Purchase Return'])
            sheet.write(row, col + 74, data['Net Purchase'])
            sheet.write(row, col + 75, data['Sales'])
            sheet.write(row, col + 76, data['Sales Return'])
            sheet.write(row, col + 77, data['Net Sales'])
            sheet.write(row, col + 78, data['Closing Stock'])
            sheet.write(row, col + 79, data['Pending SOs customers'])
            sheet.write(row, col + 80, data['Pending POs vendors'])
...
class LocationReport(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet.write(0, 44, 'Vendor Location', bold)
        sheet.write(0, 45, 'Virtual Locations/Inventory adjustment', bold)
        sheet.write(0, 46, 'Virtual Locations/Scrap', bold)
        sheet.write(0, 47, 'Virtual Locations/Production', bold)
        sheet.write(0, 48, 'Total Qty', bold)
        sheet.write(0, 49, 'Quotation Qty', bold)
        sheet.write(0, 50, 'Confirmed SO qty', bold)
        ...
        for product_id, data in sorted(product_data.items(), key=lambda x: (
            ...
            sheet.write(row, col + 44, data['Vendor Location'])
            sheet.write(row, col + 45, data['Virtual Locations/Inventory adjustment'])
            sheet.write(row, col + 46, data['Virtual Locations/Scrap'])
            sheet.write(row, col + 47, data['Virtual Locations/Production'])
            sheet.write(row, col + 48, data['Total'])
            sheet.write(row, col + 49, data['Quotation Qty'])
            sheet.write(row, col + 50, data['Confirmed SO qty'])
