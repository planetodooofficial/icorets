...
class LocationReportWizard(models.TransientModel):
    ...
    def location_report_xlsx(self):
        ...
        sheet.write(0, 40, 'BWMIS Stock', bold)
        sheet.write(0, 41, 'Customer Location', bold)
        sheet.write(0, 42, 'Vendor Location', bold)
        sheet.write(0, 43, 'Virtual Locations/Inventory adjustment', bold)
        sheet.write(0, 44, 'Virtual Locations/Scrap', bold)
        sheet.write(0, 45, 'Virtual Locations/Production', bold)
        sheet.write(0, 46, 'Total Qty', bold)
        sheet.write(0, 47, 'Quotation Qty', bold)
        sheet.write(0, 48, 'Confirmed SO qty', bold)
        sheet.write(0, 49, 'FREE TO USE', bold)
        sheet.write(0, 50, 'PO Receipt Pending', bold)
        sheet.write(0, 51, 'To Replenish', bold)
        sheet.write(0, 52, 'Bullet Point 1', bold)
        sheet.write(0, 53, 'Bullet Point 2', bold)
        sheet.write(0, 54, 'Bullet Point 3', bold)
        sheet.write(0, 55, 'Bullet Point 4', bold)
        sheet.write(0, 56, 'Bullet Point 5', bold)
        sheet.write(0, 57, 'Description', bold)
        sheet.write(0, 58, 'Google Drive Link', bold)
        sheet.write(0, 59, 'Drop Box Link', bold)
        sheet.write(0, 60, 'Country of Origin', bold)
        sheet.write(0, 61, 'Product Net Weight (gms)', bold)
        sheet.write(0, 62, 'Product Length (cm)', bold)
        sheet.write(0, 63, 'Product Breadth (cm)', bold)
        sheet.write(0, 64, 'Product Height (cm)', bold)
        sheet.write(0, 65, 'Package Gross Weight (gms)', bold)
        sheet.write(0, 66, 'Package Length (cm)', bold)
        sheet.write(0, 67, 'Package Breadth (cm)', bold)
        sheet.write(0, 68, 'Package Height (cm)', bold)
        # sheet.write(0, 30, '(Onhand + incoming) - outgoing', bold)
        # sheet.write(0, 31, '(Onhand + incoming) - outgoing(With_Qtn)', bold)

        sheet.write(0, 69, 'Opening Stock', bold_yellow)
        sheet.write(0, 70, 'Purchase', bold_yellow)
        sheet.write(0, 71, 'Purchase Return', bold_yellow)
        sheet.write(0, 72, 'Net Purchase', bold_yellow)
        sheet.write(0, 73, 'Sales', bold_yellow)
        sheet.write(0, 74, 'Sales Return', bold_yellow)
        sheet.write(0, 75, 'Net Sales', bold_yellow)
        sheet.write(0, 76, 'Closing Stock', bold_yellow)
        sheet.write(0, 77, 'Pending SOs customers', bold_yellow)
        sheet.write(0, 78, 'Pending POs vendors', bold_yellow)
        ...
        for product_id, data in sorted(product_data.items(), key=lambda x: (
            ...
            sheet.write(row, col + 40, data['BWMIS Stock'])
            sheet.write(row, col + 41, data['Customer Location'])
            sheet.write(row, col + 42, data['Vendor Location'])
            sheet.write(row, col + 43, data['Virtual Locations/Inventory adjustment'])
            sheet.write(row, col + 44, data['Virtual Locations/Scrap'])
            sheet.write(row, col + 45, data['Virtual Locations/Production'])
            sheet.write(row, col + 46, data['Total'])
            sheet.write(row, col + 47, data['Quotation Qty'])
            sheet.write(row, col + 48, data['Confirmed SO qty'])
            sheet.write(row, col + 49, data['FREE TO USE'])
            sheet.write(row, col + 50, data['PO Receipt Pending'])
            sheet.write(row, col + 51, data['To Replenish'])

            sheet.write(row, col + 52, data['Bullet Point 1'])
            sheet.write(row, col + 53, data['Bullet Point 2'])
            sheet.write(row, col + 54, data['Bullet Point 3'])
            sheet.write(row, col + 55, data['Bullet Point 4'])
            sheet.write(row, col + 56, data['Bullet Point 5'])
            sheet.write(row, col + 57, data['Description'])
            sheet.write(row, col + 58, data['Google Drive Link'])
            sheet.write(row, col + 59, data['Drop Box Link'])
            sheet.write(row, col + 60, data['Country of Origin'])

            sheet.write(row, col + 61, data['Product Net Weight (gms)'])
            sheet.write(row, col + 62, data['Product Length (cm)'])
            sheet.write(row, col + 63, data['Product Breadth (cm)'])
            sheet.write(row, col + 64, data['Product Height (cm)'])
            sheet.write(row, col + 65, data['Package Gross Weight (gms)'])
            sheet.write(row, col + 66, data['Package Length (cm)'])
            sheet.write(row, col + 67, data['Package Breadth (cm)'])
            sheet.write(row, col + 68, data['Package Height (cm)'])
            # sheet.write(row, col +30, data['(Onhand + incoming) - outgoing'])
            # sheet.write(row, col + 31, data['(Onhand + incoming) - outgoing(With_Qtn)'])

            sheet.write(row, col + 69, data['Opening Stock'])
            sheet.write(row, col + 70, data['Purchase'])
            sheet.write(row, col + 71, data['Purchase Return'])
            sheet.write(row, col + 72, data['Net Purchase'])
            sheet.write(row, col + 73, data['Sales'])
            sheet.write(row, col + 74, data['Sales Return'])
            sheet.write(row, col + 75, data['Net Sales'])
            sheet.write(row, col + 76, data['Closing Stock'])
            sheet.write(row, col + 77, data['Pending SOs customers'])
            sheet.write(row, col + 78, data['Pending POs vendors'])
